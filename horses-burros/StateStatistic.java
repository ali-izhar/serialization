...
public class StateStatistic extends Statistic {
	...
	/** the serialization unique ID for this version **/
	private static final long serialVersionUID = 8989203120325037769L;
	...
	/**
	 * print state's details
	 */
	public String toString() {
		return ("State: " + state + " \tHorses: " + numHorses + " \tBurros: " + numBurros);
	}
